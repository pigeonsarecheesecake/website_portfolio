...
const Experience = () => { 
    ...
    <div className={`col-span-1 flex items-center opacity-0 transition-all duration-[1500ms] ${inView ? "show" : ""}`} ref={ref1} >
        <h1 className="text-4xl md:text-6xl" >Experience</h1>
    </div>
    {/* Experience Right Side (Experiences) */}
    <div className={`col-span-1 flex flex-col justify-between opacity-0 transition-all duration-[1500ms] ${inView2 ? "show" : ""}`} ref={ref2}>
