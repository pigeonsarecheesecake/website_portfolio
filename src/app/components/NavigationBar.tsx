...
const NavigationBar = () => {
    ...
    return (
        <div className=' py-24 px-8 md:px-12 lg:px-48 2xl:px-72  flex justify-between '>
            ...
            <ul className=" socials-logos hidden md:flex ">
                <a className="transition-all ease-linear duration-300 hover:text-gray-500" href='https://github.com/pigeonsarecheesecake' target="_blank">
                ...
                <a className="transition-all ease-linear duration-300 hover:text-gray-500" href='https://www.linkedin.com/in/william-ryuputra-470856197/' target="_blank">
