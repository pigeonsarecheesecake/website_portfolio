...
const page = () => {
  ...
  const props = {
    ...
    intro:
    `Three years after obtaining my bachelor's degree, I decided to pursue a career as a full-stack developer. Finding internship opportunities post-graduation was challenging but 3D Circuitry gave me the chance to be part of something big, regardless of my background. 
